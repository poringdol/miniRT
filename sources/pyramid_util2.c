...
/*   Updated: 2020/08/02 01:51:19 by pdemocri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pyr->tri1.rgb = pyr->sqr.pln.rgb;
	pyr->tri1.top1 = pyr->sqr.top1;
	pyr->tri1.top2 = pyr->sqr.top2;
	pyr->tri1.top3 = pyr->top;
	pyr->tri1.pln.xyz = pyr->top;
	pyr->tri1.pln.orient = vect_product(vect_cord(pyr->tri1.top1, pyr->tri1.top2),
										vect_cord(pyr->tri1.top1, pyr->top));
...
{
	pyr->tri2.rgb = pyr->sqr.pln.rgb;
	pyr->tri2.top1 = pyr->sqr.top2;
	pyr->tri2.top2 = pyr->sqr.top3;
	pyr->tri2.top3 = pyr->top;
	pyr->tri2.pln.xyz = pyr->top;
	pyr->tri2.pln.orient = vect_product(vect_cord(pyr->tri2.top1, pyr->tri2.top2),
										vect_cord(pyr->tri2.top1, pyr->top));
...
{
	pyr->tri3.rgb = pyr->sqr.pln.rgb;
	pyr->tri3.top1 = pyr->sqr.top3;
	pyr->tri3.top2 = pyr->sqr.top4;
	pyr->tri3.top3 = pyr->top;
	pyr->tri3.pln.xyz = pyr->top;
	pyr->tri3.pln.orient = vect_product(vect_cord(pyr->tri3.top1, pyr->tri3.top2),
										vect_cord(pyr->tri3.top1, pyr->top));
...
{
	pyr->tri4.rgb = pyr->sqr.pln.rgb;
	pyr->tri4.top1 = pyr->sqr.top4;
	pyr->tri4.top2 = pyr->sqr.top1;
	pyr->tri4.top3 = pyr->top;
	pyr->tri4.pln.xyz = pyr->top;
	pyr->tri4.pln.orient = vect_product(vect_cord(pyr->tri4.top1, pyr->tri4.top2),
										vect_cord(pyr->tri4.top1, pyr->top));
